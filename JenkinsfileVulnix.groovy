            ...
            steps {
                script {
                    ...
                    writeFile (file: JUNIT_OUTPUT_JSON,
                               text: (sh (script: "vulnix --whitelist https://gitlab.intr/webservices/vulnix/-/raw/master/whitelist.toml --cache-dir $VULNIX_CACHE_DIRECTORY --json $params.DOCKER_IMAGE || true",
